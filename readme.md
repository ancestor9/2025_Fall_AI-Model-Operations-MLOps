...
| 4주차 | Modern Web 및 HTTP 구조 (Request Line, Headers, Body) 복습.<br>FastAPI 시작을 위한 환경 설정 (Firebase, 가상환경, FastAPI/uvicorn 설치) 준비. FastAPI 기본 (Path, Query, Header, Body) 및 Router 이해|
